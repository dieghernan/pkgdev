...
- For bugs, [file an
  issue](https://github.com/dieghernan/pkgdev/issues/new).
...
requests](https://github.com/dieghernan/pkgdev/issues) to make sure the
...
**pkgdev** is primarily maintained for personal use, so a response may
not be immediate. Issues may be addressed in batches, which can delay
