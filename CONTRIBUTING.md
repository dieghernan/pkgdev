...
This guide explains how to propose a change to **pkgdev**. Review the
...
If you want to make a bigger change, first file an issue and confirm
that it fits the package’s scope. If you have found a bug, file an issue
...
- Fork the package and clone it onto your computer. If you have not done
  this before, use
  `usethis::create_from_github("dieghernan/pkgdev", fork = TRUE)`.
- Install all development dependencies with
  [`devtools::install_dev_deps()`](https://devtools.r-lib.org/reference/install_deps.html),
  then make sure the package passes the `R CMD check` command by running
  [`devtools::check()`](https://devtools.r-lib.org/reference/check.html).
  If the check does not pass cleanly, ask for help before continuing.
...
Please note that the **pkgdev** project is released with a [Contributor
Code of
Conduct](https://dieghernan.github.io/pkgdev/CODE_OF_CONDUCT.md). By
