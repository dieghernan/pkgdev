...
mypaks <- c(
  ...
  "CatastRo", "CatastRoNav", "rostemplate", "igoR", "rstudiothemes",
...
# Factors by average monthly downloads.
fact <- dwn_m |>
  group_by(package) |>
...
# Combine summaries and apply display names.
end <- fechas |>
  left_join(avg_daily) |>
  left_join(last_day) |>
  left_join(lastweek) |>
...
names(res_all) <- c(
  "package", "Latest version", "CRAN version",
