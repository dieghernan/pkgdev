...
Downloads and data available of my packages from [Posit Package Manager](https://packagemanager.posit.co/client/#/).
...
res <- lapply(mypaks, function(x) {
  ...
  len1 <- vapply(info, length, FUN.VALUE = integer(1)) == 1
  df_init <- as.data.frame(info[len1])
